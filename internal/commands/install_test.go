...
func TestInstallWritesKoryphCommands(t *testing.T) {
	...
	for _, want := range []string{"koryph-adopt", "koryph-calibrate", "koryph-import", "koryph-issue", "koryph-build", "koryph-loop", "koryph-plan", "koryph-replan", "koryph-stop", "koryph-kill"} {
		if !got[want] {

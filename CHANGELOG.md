...
## [0.11.0](https://github.com/koryph/koryph/compare/v0.10.0...v0.11.0) (2026-07-26)
...
* **ci:** install docs pages assets ([919a122](https://github.com/koryph/koryph/commit/919a122b61db00921c2f1a0a4a3dc56a3d917186))
...
* **doctor:** check container Dockerfile prerequisite ([1bcafba](https://github.com/koryph/koryph/commit/1bcafbac4a4b40225681c4fa6a58919e7262db06))
...
* **doctor:** validate container release workflow ([7e8e11e](https://github.com/koryph/koryph/commit/7e8e11eb0dbb109193c1f09565ece852d54660e0))
...
* **ledger:** gate versioned ledger writes ([c339945](https://github.com/koryph/koryph/commit/c339945c49fb933ffcf96d730c3925a2a7822d37))
* **ledger:** persist capability retry evidence holds ([98f9688](https://github.com/koryph/koryph/commit/98f96884f8753a275c6846d740258e7a7452712a))
...
* **plan:** enforce atomic acceptance evidence ([bd22ee2](https://github.com/koryph/koryph/commit/bd22ee2919fb78099b0ce35036950f0f6d823192))
* **plan:** enforce dispatch unit contracts ([4671d19](https://github.com/koryph/koryph/commit/4671d194aa75bf4ea131e2d753acc52cab9260e8))
...
* **schemaver:** add migration fingerprints ([8eab275](https://github.com/koryph/koryph/commit/8eab2754551ec05077f2723e9e492a12409c9cc0))
* **signing:** guard versioned vault state ([7eb9682](https://github.com/koryph/koryph/commit/7eb96821384d2772cbc600a09546f7ce7ab61088))
...
* **ci:** honor docs default branch ([eafbf5f](https://github.com/koryph/koryph/commit/eafbf5fcb9da1edd36dc4b0af946d27e6591da8b))
* **ci:** restrict docs deployments to default branch ([b33b6ac](https://github.com/koryph/koryph/commit/b33b6ac26d823b22fdaa1b553ebc224d01ce96a8))
* **ci:** scope docs pages permissions ([1ca857a](https://github.com/koryph/koryph/commit/1ca857a72bcb61fcef96b40e7aad34f015577c87))
...
* **cockpit:** count finalization footprints ([0a5b26a](https://github.com/koryph/koryph/commit/0a5b26a952b7b8c2220571baed049be401cefd86))
...
* **dispatch:** keep Beads context in the control plane ([8e944a0](https://github.com/koryph/koryph/commit/8e944a01bdee4899067446752eab7c5ca9206f16))
...
* **doctor:** reject container gate bypasses ([82b0bb5](https://github.com/koryph/koryph/commit/82b0bb537981b81004c5d477c90451be448aa779))
* **doctor:** validate container publication controls ([650a95c](https://github.com/koryph/koryph/commit/650a95cc2df4c578669dc76a5b395e1e0b61e157))
...
* **engine:** contain capability retries per slot ([3cddcfc](https://github.com/koryph/koryph/commit/3cddcfc40e5dc0f0a356297f3d84974f25e9b73d))
* **engine:** contain exhausted candidates to their slots ([24a3e16](https://github.com/koryph/koryph/commit/24a3e16838368444875a8edcdba9f48d5017bf04))
* **engine:** contain worker context and gate repairs ([a454df9](https://github.com/koryph/koryph/commit/a454df9982356b31b2d2e5257e42d0c725462c23))
...
* **engine:** enforce evidence-bound autonomous lifecycle ([f762a2f](https://github.com/koryph/koryph/commit/f762a2f1cd8e5408a36380cc651129b80617c8f8))
...
* **engine:** preserve admitted repair retries ([e4f1594](https://github.com/koryph/koryph/commit/e4f15946eafcf751e5186fcda07569162e0212ae))
* **engine:** preserve standard repair tier ([bcbe30f](https://github.com/koryph/koryph/commit/bcbe30fdb5dd99babcbabe0916fe2f7db91bdc7d))
...
* **engine:** provide gate evidence to repair retries ([beef149](https://github.com/koryph/koryph/commit/beef14987287a2cdd76ed40e522de672679bfa05))
...
* **engine:** recover reopened candidates ([5b4dc1b](https://github.com/koryph/koryph/commit/5b4dc1b0b1a2d5f3e3a1a1145e3bf210f02bb76f))
...
* **engine:** reject invalid input before model dispatch ([740674f](https://github.com/koryph/koryph/commit/740674f10b716e8b0a05ea25913dd2af38e9aeae))
* **engine:** restore autonomous loop reliability ([27d0e79](https://github.com/koryph/koryph/commit/27d0e795356533986f0c5e8c8d47a3cecb3f2c3b))
* **engine:** resume completed slots without redispatch ([3e48a21](https://github.com/koryph/koryph/commit/3e48a21608496032a6a5b627db1c121666a45e57))
...
* **gc:** preserve nonterminal phase caches ([3b92d2e](https://github.com/koryph/koryph/commit/3b92d2e9146a75dbf1a96f82c89898057493b67a))
* **gc:** prune terminal phase caches ([6dcca5b](https://github.com/koryph/koryph/commit/6dcca5beff2df39435a826bb091e57e15d6985ae))
...
* **ledger:** license fingerprint fixtures ([6577c8c](https://github.com/koryph/koryph/commit/6577c8c831853bb4e7ddc16d815abf39c6b9cb5e))
* **ledger:** serialize capability hold updates ([edd0414](https://github.com/koryph/koryph/commit/edd0414092354525d83950e039b69ab94b4754b5))
* **loop:** allow audited canary cohort supersession ([c82819c](https://github.com/koryph/koryph/commit/c82819c10fdf3b251221920e1606a0997534b8c0))
* **loop:** allow audited canary policy supersession ([f38fc8a](https://github.com/koryph/koryph/commit/f38fc8aba2954ee235129dff28935051b8899c03))
* **loop:** contain autonomous canary failures ([7f7d999](https://github.com/koryph/koryph/commit/7f7d999179e001b59a0eb9f113635107de35e316))
* **loop:** decouple steady admission from canary promotion ([f1bebb1](https://github.com/koryph/koryph/commit/f1bebb1198f8b2b14911e0627cf1e60f635abcbb))
* **loop:** finalize interrupted canary ([bdcfbfc](https://github.com/koryph/koryph/commit/bdcfbfcbbd8cf45a202b076a9c26ee0fa3a50842))
* **loop:** reset retired canary generation ([0be8d3e](https://github.com/koryph/koryph/commit/0be8d3e31b5ac6f0b2cd673ec5f98f242f7e13a5))
* **loop:** retire failed state from dead supervisor ([f8f95a3](https://github.com/koryph/koryph/commit/f8f95a319cdb4e463cf830879f5ae63cd96fbbc9))
* **loop:** roll empty canary forward ([820d7ae](https://github.com/koryph/koryph/commit/820d7ae26bdcec918d8f79f6807d7a73bd9e1d0f))
* **loop:** secure canary bootstrap ([064daf5](https://github.com/koryph/koryph/commit/064daf5e277adb217734c82b26043f47a9526956))
* **merge:** preflight blocked direnv fallback ([837aa1b](https://github.com/koryph/koryph/commit/837aa1b80dbaeecdb5b489e447090f08672983d5))
...
* **ops:** rearm repaired capability holds ([6698aa4](https://github.com/koryph/koryph/commit/6698aa4bcc701904ea49cba349b700ecc19482c5))
* **phase:** snapshot terminal evidence ([1338632](https://github.com/koryph/koryph/commit/1338632e6c76f2b27a7adbd9ff414f5d79039908))
* **plan:** accept release unit kinds ([dd4dd59](https://github.com/koryph/koryph/commit/dd4dd59322eecc53f0c3059c98e58528bdb194c1))
...
* **prompt:** distinguish required focused checks ([558cfa8](https://github.com/koryph/koryph/commit/558cfa80780e9f694a29997db1facd27811f8b5f))
...
* **release:** scope container publish permissions ([f43e4cb](https://github.com/koryph/koryph/commit/f43e4cb85621fc502755368f5128cc8796e479a9))
* **review:** stabilize concurrent artifact replay ([e68183d](https://github.com/koryph/koryph/commit/e68183db0b43e08f4a44abeaf4ef37443b4303b2))
...
* **runtime:** bind command lease to full cohort ([1ec35f8](https://github.com/koryph/koryph/commit/1ec35f8663b77e62443b166d617ad3d3e6939384))
* **runtime:** contain cache and gate retries ([51f7cee](https://github.com/koryph/koryph/commit/51f7ceecfe457e65999f0d91bfae81b1a498d509))
...
* **schemaver:** bump project schema fingerprint ([fd02199](https://github.com/koryph/koryph/commit/fd02199fbaab6ce9accb2cab07688a579453af07))
* **schemaver:** correct ledger fingerprint golden ([5cc494e](https://github.com/koryph/koryph/commit/5cc494e7c82dc0ed9553aea281c97be8470f4d2e))
* **schemaver:** license fingerprint fixture ([76a0195](https://github.com/koryph/koryph/commit/76a01956ddc6c745ad4d4283bdb4526adf6e4ca1))
* **schemaver:** migrate legacy ledger state ([c389741](https://github.com/koryph/koryph/commit/c389741d4922704a91f8ad41a50a20409818e860))
* **schemaver:** reconcile current schema histories ([99aeff5](https://github.com/koryph/koryph/commit/99aeff5b1569232fff24f719207eb44badb256f5))
* **schemaver:** report migration changes ([dfa4251](https://github.com/koryph/koryph/commit/dfa4251d4a824d43cc5496cacba8c8ffad889e1f))
* **schemaver:** restore foundation-only ownership ([226a6b8](https://github.com/koryph/koryph/commit/226a6b829e60ec7831ef7452fc747a1773101723))
...
* **agents:** use medium effort for routine work ([cb22a82](https://github.com/koryph/koryph/commit/cb22a82202831724455ef2316c509940683310cc))
* **engine:** finalize candidates asynchronously ([ac690d4](https://github.com/koryph/koryph/commit/ac690d4fde045b5e19f12ef0b43cbe2a14eff2e0))
